...
void Setup(void)
{
    ...
    pScene->AddSurface(new Sphere(STVector3(2, 0.5, -1.5), 0.5, RGBR_f(255, 255, 255, 255), metal));
    pScene->AddSurface(new Sphere(STVector3(0, 0, 0), 1.25, RGBR_f(255, 255, 255, 255), metal));
