...
{
    SetLookAt(STVector3(0.f,0.f,0.f));
    m_Position=STVector3(0.0f,0.0f,0.f);
...
//
STVector3 Camera::GetPosition (void)
{
    return(m_Position);
}
...
STVector3 Camera::GetLookAt (void)
{
    return(m_LookAt);
}
...
STVector3 Camera::GetUp (void)
{
    return(m_Up);
}

void Camera::SetLookAt(STVector3 newLookAt) {
    m_LookAt = newLookAt;
    m_LookAt.Normalize();
}

void Camera::SetPosition(STVector3 newPosition) {
